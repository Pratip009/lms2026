...
const styles = `
  ...
  .lc-live-badge {
    ...
    font-size: 10.5px; font-weight: 700; font-family: var(--f-display);
  ...
  .lc-tab {
    ...
    background: transparent; color: var(--c-ink4);
    transition: all .15s; font-family: var(--f-display);
    white-space: nowrap;
  }
  .lc-tab:hover { color: var(--c-ink2); background: var(--c-surface2); }
  .lc-tab.active {
    background: var(--c-blue50); color: var(--c-blue600);
    border-color: var(--c-blue200);
  }

  /* ═══════════════════════════════════════════
     MAIN LAYOUT (chat col + participants)
  ═══════════════════════════════════════════ */
  .lc-body {
    flex: 1; min-height: 0;
  ...
  .lc-p-head-title {
    ...
    color: var(--c-ink4); font-family: var(--f-display); margin-bottom: 10px;
  }
  ...
  .lc-online-pill {
    ...
    padding: 5px 8px; border-radius: var(--r-sm); font-size: 10.5px; font-weight: 600;
    font-family: var(--f-display);
  }
  ...
  .lc-p-section-label {
    ...
    color: var(--c-ink5); font-family: var(--f-display);
    padding: 8px 6px 3px;
  }
  ...
  .lc-p-avatar {
    ...
    font-family: var(--f-display); overflow: hidden; position: relative;
    letter-spacing: .02em;
  }
  ...
  .lc-p-name {
    font-size: 11.5px; font-weight: 600; color: var(--c-ink2);
  ...
  .lc-p-row.is-self {
    ...
    border: 1px solid var(--c-blue200);
  ...
  .lc-p-you-pill {
    ...
    border: 1.5px solid var(--c-blue200);
    border-radius: 5px;
    padding: 1px 7px;
  ...
  .lc-p-online-status {
    display: inline-flex; align-items: center; gap: 4px;
    font-size: 10px; color: var(--c-green); font-weight: 600;
  }
  .lc-p-online-status::before {
  ...
  .lc-date-label {
    ...
    color: var(--c-ink4); white-space: nowrap; font-family: var(--f-display);
    background: var(--c-bg); padding: 0 4px;
  }
  ...
  .lc-msg-group {
    ...
    margin-bottom: 14px;
    animation: lc-slideUp .22s ease both;
  }
  ...
  .lc-avatar {
    ...
    letter-spacing: .03em; overflow: hidden; font-family: var(--f-display);
  ...
  .lc-role-tag {
    ...
    padding: 2px 6px; border-radius: 5px; font-family: var(--f-display);
    background: var(--c-violet-lt); color: var(--c-violet); border: 1px solid var(--c-violet-bd);
  }
  .lc-resolved-tag {
    font-size: 9px; font-weight: 700; letter-spacing: .07em; text-transform: uppercase;
    padding: 2px 6px; border-radius: 5px; font-family: var(--f-display);
    background: var(--c-green-lt); color: var(--c-green); border: 1px solid var(--c-green-bd);
    display: inline-flex; align-items: center; gap: 3px;
  }
  .lc-you-tag {
    display: inline-flex; align-items: center;
    font-size: 11.5px; font-weight: 800; font-family: var(--f-display);
    letter-spacing: .03em;
    color: var(--c-blue600);
    background: var(--c-blue50);
    border: 1.5px solid var(--c-blue200);
  ...
  .lc-msg-time {
    font-size: 10px; color: var(--c-ink5); font-weight: 400; margin-left: 2px;
  }
  ...
  /* spacer so grouped msgs indent under avatar */
  ...
  .lc-bubble.bbl-student {
    background: var(--c-surface); border: 1px solid var(--c-border);
    color: var(--c-ink2); border-bottom-left-radius: 4px;
    box-shadow: 0 1px 4px rgba(15,23,42,0.05);
  }
  .lc-bubble.bbl-student:hover { box-shadow: 0 3px 12px rgba(15,23,42,0.09); }
  .lc-bubble.bbl-instructor {
    background: var(--c-violet-lt); border: 1px solid var(--c-violet-bd);
    color: #3b1fa5; border-bottom-left-radius: 4px;
    box-shadow: 0 1px 6px rgba(124,58,237,0.1);
  }
  .lc-bubble.bbl-instructor:hover { box-shadow: 0 3px 14px rgba(124,58,237,0.16); }
  .lc-bubble.bbl-own {
    background: linear-gradient(135deg, var(--c-blue500), var(--c-blue700));
    color: #fff; border: none; border-bottom-right-radius: 4px;
    box-shadow: 0 3px 14px rgba(37,99,235,0.28);
    position: relative; overflow: hidden;
  }
  .lc-bubble.bbl-own::after {
    content: ''; position: absolute; top: 0; left: -100%; width: 50%; height: 100%;
    background: linear-gradient(90deg, transparent, rgba(255,255,255,0.12), transparent);
    animation: lc-shimmer 3s ease-in-out infinite;
  }
  .lc-bubble.bbl-own:hover { box-shadow: 0 6px 22px rgba(37,99,235,0.36); transform: translateY(-1px); }

  /* Reply quote inside bubble */
  .lc-reply-quote {
    border-left: 3px solid rgba(0,0,0,0.12); padding-left: 10px; margin-bottom: 8px;
    font-size: 11.5px; opacity: .7; border-radius: 0 4px 4px 0;
    background: rgba(0,0,0,0.04); padding: 5px 10px; border-radius: 6px; margin-bottom: 9px;
  }
  ...
  .lc-file-card {
    ...
    margin-top: 8px; transition: all .15s; cursor: pointer;
    min-width: 0;
  }
  .bbl-student .lc-file-card, .bbl-instructor .lc-file-card {
    background: var(--c-bg); border: 1px solid var(--c-border);
  }
  .bbl-student .lc-file-card:hover, .bbl-instructor .lc-file-card:hover {
    border-color: var(--c-blue200); background: var(--c-blue50); box-shadow: 0 2px 10px rgba(37,99,235,0.09);
  }
  .bbl-own .lc-file-card {
  ...
  .bbl-student .lc-file-card:hover .lc-file-dl,
  .bbl-instructor .lc-file-card:hover .lc-file-dl { background: var(--c-blue600); color: #fff; }
  .bbl-own .lc-file-card:hover .lc-file-dl { background: rgba(255,255,255,0.2); color: #fff; }

  /* Message actions */
  .lc-msg-actions {
    display: flex; gap: 5px; margin-top: 5px;
    opacity: 0; transition: opacity .15s; padding: 0 4px;
  }
  .lc-bubble-row:hover + .lc-msg-actions,
  .lc-msg-actions:hover { opacity: 1; }
  .lc-msg-action-btn {
    background: none; border: 1px solid var(--c-border); cursor: pointer;
    font-size: 10.5px; color: var(--c-ink4); padding: 2px 9px; border-radius: 6px;
    font-family: var(--f-body); transition: all .13s; font-weight: 500;
  }
  ...
  .lc-loading {
    ...
    gap: 10px; color: var(--c-ink4); font-size: 13px;
  }
  .lc-spinner {
    width: 18px; height: 18px; border: 2px solid var(--c-border);
    border-top-color: var(--c-blue500); border-radius: 50%;
  ...
  .lc-empty-icon {
    ...
    background: var(--c-blue50); border: 1px solid var(--c-blue200);
    display: flex; align-items: center; justify-content: center; font-size: 26px;
    box-shadow: 0 4px 16px rgba(37,99,235,0.1);
    animation: lc-popIn .3s ease both;
  }
  ...
  .lc-error-bar {
    ...
    border-radius: var(--r-sm); font-size: 12px; color: var(--c-rose);
  ...
  .lc-new-badge {
    ...
    background: var(--c-blue600); color: #fff;
    font-size: 11.5px; font-weight: 700; font-family: var(--f-display);
    padding: 7px 16px; border-radius: 100px; cursor: pointer; z-index: 10;
    box-shadow: 0 4px 16px rgba(37,99,235,0.4); transition: all .15s; white-space: nowrap;
    letter-spacing: .03em;
  }
  ...
  .lc-reply-bar {
    ...
    background: var(--c-blue50);
    border: 1px solid var(--c-blue200); border-radius: var(--r-sm);
    font-size: 12px;
    animation: lc-fadeUp .2s ease both;
  }
  ...
  .lc-reply-bar-close {
    background: none; border: none; cursor: pointer; color: var(--c-ink4);
    font-size: 14px; line-height: 1; padding: 0 2px; flex-shrink: 0; transition: color .13s;
  }
  ...
  .lc-file-chip {
    ...
    padding: 4px 10px; background: var(--c-blue50);
    border: 1px solid var(--c-blue200); border-radius: 7px;
    font-size: 11px; color: var(--c-ink2); max-width: 160px;
  }
  ...
  .lc-icon-btn {
    ...
    display: flex; align-items: center; justify-content: center;
    font-size: 16px; border: 1.5px solid var(--c-border2);
    background: var(--c-surface); cursor: pointer; transition: all .14s; flex-shrink: 0;
  }
  ...
  .lc-send-btn {
    ...
    font-size: 16px; color: #fff; cursor: pointer; transition: all .15s;
    box-shadow: 0 3px 12px rgba(37,99,235,0.3); position: relative; overflow: hidden;
  }
  .lc-send-btn::after {
    content: ''; position: absolute; top: 0; left: -100%; width: 60%; height: 100%;
    background: linear-gradient(90deg, transparent, rgba(255,255,255,0.25), transparent);
    animation: lc-shimmer 2.8s ease-in-out infinite; pointer-events: none;
  }
  ...
  .lc-hint {
    margin-top: 7px; font-size: 10.5px; color: var(--c-ink5);
    display: flex; align-items: center; gap: 5px;
  }
  .lc-hint kbd {
    padding: 1px 5px; border: 1px solid var(--c-border2); border-radius: 4px;
    font-size: 10px; font-family: var(--f-body); background: var(--c-surface2);
    color: var(--c-ink4);
  }
...
function ParticipantRow({ p, currentUser }) {
  ...
  return (
    <div className={`lc-p-row${isSelf ? " is-self" : ""}`}>
      <div className={`lc-p-avatar ${isInstructor ? "instructor" : "student"}${isSelf ? " is-self" : ""}`}>
        {avatarUrl
    ...
    <div className={`lc-participants${!visible ? " hidden" : ""}`}>
      ...
      <div className="lc-p-list">
        ...
        {participants.length === 0 && (
          <div style={{padding:"24px 8px",textAlign:"center",fontSize:12,color:"var(--c-ink4)"}}>No participants yet</div>
        )}
      </div>
    </div>
  );
...
export default function LessonChat({ courseId, lessonId, currentUser }) {
  ...
  useEffect(() => {
    initialDone.current = false; prevCount.current = 0;
    fetchMessages().then(() => { initialDone.current = true; });
    fetchParticipants();
    pollRef.current = setInterval(() => { fetchMessages(true); fetchParticipants(); }, POLL_MS);
  ...
  const handleTextChange = (e) => {
    ...
    const el = e.target; el.style.height = "auto"; el.style.height = Math.min(el.scrollHeight, 130) + "px";
  };
  ...
  const handleDownload = async (msgId, fi, fileName) => {
    try {
      const res = await api.get(`/courses/${courseId}/lessons/${lessonId}/chat/download/${msgId}/${fi}`, { responseType: "blob" });
  ...
  const handleResolve = async (msgId) => {
    try { await api.patch(`/courses/${courseId}/lessons/${lessonId}/chat/${msgId}/resolve`); await fetchMessages(true); } catch {}
  };
  ...
  // Group consecutive same-sender msgs into groups
  const groups = [];
  visible.forEach((msg, i) => {
    ...
    if (newSender) {
      groups.push({ type: "group", sender: msg.sender, isFirst: true, msgs: [msg] });
    } else {
      ...
      <div key={g.msgs[0]._id} className={`lc-msg-group${isSelf ? " own" : ""}`}>
        ...
        <div className="lc-msg-header">
          <div className={`lc-avatar ${avCls}`}>
            {avatarUrl
              ? <img src={avatarUrl} alt={g.sender?.name} onError={e=>{e.currentTarget.style.display="none"; e.currentTarget.parentNode.textContent=initials(g.sender?.name);}} />
                ...
                {groups.length === 0 ? (
                  <div className="lc-empty">
                    ...
                    <div className="lc-empty-sub">
                      {tab==="all" ? "Be the first to ask a question or start a discussion!"
                        : tab==="resources" ? "No files or resources have been shared in this lesson."
